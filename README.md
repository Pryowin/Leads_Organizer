...
- **Filters** (saved per character) — Toggle “always available” leads, leads you have **completed before**, and optionally **hide** entries where your **Scrying** skill is too low.
