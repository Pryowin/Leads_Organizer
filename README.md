...
- **Lead actions** — Click a lead to select it, then use the **keybind strip at the bottom of the screen** (same as the Antiquities journal): **Scry** (Interact), **View in Codex** (Interact with Player), and **Close**.
